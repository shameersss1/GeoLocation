...
public class UserListActivity extends FragmentActivity implements LocationListener,
...
android.os.Handler handler;
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    a = currentUser.getUsername().toString();
    ...
    postsListView.setOnItemClickListener(new OnItemClickListener() {
      public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        selectedPostObjectId = item.getUser().getUsername().toString();

        String phone = item.getPhone().toString();
        String ad = item.getadd().toString();
        String des = item.getdes().toString();
        ...
        //Toast.makeText(getApplicationContext(),selectedPostObjectId,Toast.LENGTH_LONG).show();

        Intent i = new Intent(UserListActivity.this,Profile.class);
        i.putExtra("name",selectedPostObjectId);
...
//        }
//
//        Intent intent = new Intent(UserListActivity.this, PostActivity.class);
...
//    });
    ...
    handler.postDelayed(new Runnable() {
      ...
      public void run() {
        ...
        // Set up the query adapter
        postsQueryAdapter = new ParseQueryAdapter<AnywallPost>(UserListActivity.this, factory) {
          @Override
          public View getItemView(AnywallPost post, View view, ViewGroup parent) {
            if (view == null) {
              view = View.inflate(getContext(), R.layout.anywall_post_item, null);
  ...
  public boolean onCreateOptionsMenu(Menu menu) {
    ...
    menu.findItem(R.id.action_settings).setOnMenuItemClickListener(new OnMenuItemClickListener() {
      public boolean onMenuItemClick(MenuItem item) {
        startActivity(new Intent(UserListActivity.this, SettingsActivity.class));
        return true;
      }
    });
    return true;
